...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT a.*,c.course,Concat(a.firstname,' ',a.lastname,' ',a.middlename) as name from alumnus_bio a inner join courses c on c.id = a.course_id where a.id= ".$_GET['id']);
